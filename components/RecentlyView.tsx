    ...
    
        {
          ...
          <div className='relative'>
            <Swiper 
              ...
              navigation={{
                prevEl: '.recently_button_prev',
                nextEl: '.recently_button_next',
              }}
              pagination={false}
              autoplay={false}
              observer={true}
                    ...
                    return (
                      <SwiperSlide className='flex  border-[1px] border-solid border-[#ddd] rounded-[8px] overflow-hidden' key={item.contentid}>
                        ...
                        <div className='p-[8px] flex-1 flex flex-col justify-between'>
                          <h4 className='text-[12px] text-[#1a1a1a] font-[500]'>{item.title}</h4>
                          <span className='mt-[3px] flex items-center text-[11px] font-[600]'>
            ...
            <button className='recently_button_prev bg-gray-800 p-2 rounded absolute top-[calc(50%-15px)] left-0 transform-translate-y-1/2 z-10 cursor-pointer'><FaAngleLeft  size={20} color='#fff'/></button>
            <button className='recently_button_next bg-gray-800 p-2 rounded absolute top-[calc(50%-15px)] right-0 transform-translate-y-1/2 z-10 cursor-pointer'><FaAngleRight size={20} color='#fff'/></button>
          </div>
